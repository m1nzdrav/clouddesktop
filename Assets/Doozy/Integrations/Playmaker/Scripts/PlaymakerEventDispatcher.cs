...
namespace Doozy.Integrations.Playmaker
{
    ...
    public class PlaymakerEventDispatcher : MonoBehaviour
    {
        ...
        private void Reset()
        {
            ...
            if (TargetFsm == null)
            {
                if (EditorUtility.DisplayDialog("ActionEnter Required", "The Playmaker Event Dispatcher attached to the '" + gameObject.name + "' gameObject did not find any PlayMakerFSM component attached as well." +
                                                                   "\n\n" +
                ...
                else
                {
                    EditorUtility.DisplayDialog("Info", "You chose not to attach a PlayMakerFSM." +
                                                        "\n\n" +
                                                        "Remember that you need to reference one in mlw for this dispatcher to do anything." +
                                                        "\n\n", "Ok");
