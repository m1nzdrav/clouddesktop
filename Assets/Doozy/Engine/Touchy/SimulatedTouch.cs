...
namespace Doozy.Engine.Touchy
{
    ...
    public class SimulatedTouch
    {
        ...
        public int FingerId
        {
            get { return ((Touch) m_touch).fingerId; }
            set { Fields["m_FingerId"].SetValue(m_touch, value); }
        }

        /// <summary> The position of the touch in pixel coordinates </summary>
        public Vector2 Position
        {
            get { return ((Touch) m_touch).position; }
            set { Fields["m_Position"].SetValue(m_touch, value); }
        }

        /// <summary> The raw position used for the touch </summary>
        public Vector2 RawPosition
        {
            get { return ((Touch) m_touch).rawPosition; }
            set { Fields["m_RawPosition"].SetValue(m_touch, value); }
        }

        /// <summary> The position delta since last change </summary>
        public Vector2 DeltaPosition
        {
            get { return ((Touch) m_touch).deltaPosition; }
            set { Fields["m_PositionDelta"].SetValue(m_touch, value); }
        }

        /// <summary> Amount of time that has passed since the last recorded change in Touch values </summary>
        public float DeltaTime
        {
            get { return ((Touch) m_touch).deltaTime; }
            set { Fields["m_TimeDelta"].SetValue(m_touch, value); }
        }

        /// <summary> Number of taps </summary>
        public int TapCount
        {
            get { return ((Touch) m_touch).tapCount; }
            set { Fields["m_TapCount"].SetValue(m_touch, value); }
        }

        /// <summary> Describes the phase of the touch </summary>
        public TouchPhase Phase
        {
            get { return ((Touch) m_touch).phase; }
            set { Fields["m_Phase"].SetValue(m_touch, value); }
        }
        ...
        {
            get { return ((Touch) m_touch).pressure; }
            set { Fields["m_Pressure"].SetValue(m_touch, value); }
        }
        ...
        {
            get { return ((Touch) m_touch).maximumPossiblePressure; }
            set { Fields["m_maximumPossiblePressure"].SetValue(m_touch, value); }
        }

        /// <summary> A value that indicates whether a touch was of Direct, Indirect (or remote), or Stylus type </summary>
        public TouchType Type
        {
            get { return ((Touch) m_touch).type; }
            set { Fields["m_Type"].SetValue(m_touch, value); }
        }
        ...
        {
            get { return ((Touch) m_touch).altitudeAngle; }
            set { Fields["m_AltitudeAngle"].SetValue(m_touch, value); }
        }

        /// <summary> Value of 0 radians indicates that the stylus is pointed along the x-axis of the device </summary>
        public float AzimuthAngle
        {
            get { return ((Touch) m_touch).azimuthAngle; }
            set { Fields["m_AzimuthAngle"].SetValue(m_touch, value); }
        }
        ...
        public float Radius
        {
            get { return ((Touch) m_touch).radius; }
            set { Fields["m_Radius"].SetValue(m_touch, value); }
        }

        /// <summary> The amount that the radius varies by for a touch </summary>
        public float RadiusVariance
        {
            get { return ((Touch) m_touch).radiusVariance; }
            set { Fields["m_RadiusVariance"].SetValue(m_touch, value); }
        }
