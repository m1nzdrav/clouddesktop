...
namespace Doozy.Engine.Touchy
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.GestureListener_AddComponentMenu_MenuName,
        MenuUtils.GestureListener_AddComponentMenu_Order)]
    ...
    public class GestureListener : MonoBehaviour
    {
        ...
        {
            get { return DebugMode || DoozySettings.Instance.DebugGestureListener; }
        }
        ...
        /// <summary> ActionEnter executed when this listener is triggered </summary>
        ...
        private void SendGameEvents()
        {
            if (GameEvents == null || GameEvents.Count == 0)
                return; //check that there is at least one game event that needs to be sent before starting a coroutine
        ...
        {
            var result = DoozyUtils.AddToScene<GestureListener>(MenuUtils.GestureListener_GameObject_Name, false,
