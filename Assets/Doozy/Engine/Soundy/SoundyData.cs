...
{
    /// <summary>
    ///     Data settings container used by the Actions class in mlw to trigger the playing of a sound via Soundy, a direct AudioClip reference or a MasterAudio sound name.
    /// </summary>
    [Serializable]
    public class SoundyData
    {
        ...
        {
            return SoundySettings.Database.GetAudioData(DatabaseName, SoundName);
        }
