...
namespace Doozy.Engine.Soundy
{
    ...
    public class SoundySettings : ScriptableObject
    {
        ...
        {
            get { return DoozyPath.ENGINE_SOUNDY_RESOURCES_PATH; }
        }
        ...
        {
            Instance.database = AssetUtils.GetScriptableObject<SoundyDatabase>("_" + DoozyPath.SOUNDY_DATABASE,
                DoozyPath.GetDataPath(DoozyPath.ComponentName.Soundy), false, false);
#if UNITY_EDITOR
