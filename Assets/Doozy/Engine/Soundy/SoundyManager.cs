...
namespace Doozy.Engine.Soundy
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.SoundyManager_AddComponentMenu_MenuName,
        MenuUtils.SoundyManager_AddComponentMenu_Order)]
    ...
    public class SoundyManager : MonoBehaviour
    {
        ...
        {
            get { return SoundySettings.Database; }
        }
        ...
        {
            get { return DoozySettings.Instance.DebugSoundyManager; }
        }
        ...
        {
            return DoozyUtils.AddToScene<SoundyManager>(MenuUtils.SoundyManager_GameObject_Name, true,
        ...
        {
            return "SoundDatabase_" + databaseName.Trim();
        }
        ...
        /// <summary>
        /// _play the specified sound at the given position.
        ...
        public static SoundyController Play(string databaseName, string soundName, Vector3 position)
        {
            ...
            if (Instance.DebugComponent)
                DDebug.Log(
                    "_play '" + databaseName + "' / '" + soundName + "' SoundGroupData at " + position + " position",
                    Instance);
        ...
        /// <summary>
        /// _play the specified sound and follow a given target Transform while playing.
        /// Returns a reference to the SoundyController that is playing the sound.
        /// Returns null if no sound is found.
        /// </summary>
        /// <param name="databaseName"> The sound category </param>
        ...
        public static SoundyController Play(string databaseName, string soundName, Transform followTarget)
        {
            ...
            if (Instance.DebugComponent)
                DDebug.Log(
                    "_play '" + databaseName + "' / '" + soundName + "' SoundGroupData and follow the '" +
                    followTarget.name + "' GameObject", Instance);
            return soundGroupData.Play(followTarget, Database.GetSoundDatabase(databaseName).OutputAudioMixerGroup);
        }

        /// <summary>
        /// _play the specified sound, at the set position.
        /// Returns a reference to the SoundyController that is playing the sound.
        /// Returns null if the AudioClip is null.
        /// </summary>
        /// <param name="audioClip"> The AudioClip to play </param>
        ...
        /// <summary>
        /// _play the specified sound with the given category, name and type.
        /// Returns a reference to the SoundyController that is playing the sound.
        /// Returns null if no sound is found.
        /// </summary>
        /// <param name="databaseName"> The sound category </param>
        ...
        /// <summary>
        /// _play the specified audio clip with the given parameters, at the set position.
        /// Returns a reference to the SoundyController that is playing the sound.
        /// Returns null if the AudioClip is null.
        /// </summary>
        /// <param name="audioClip"> The AudioClip to play </param>
            ...
            float volume = 1, float pitch = 1, bool loop = false, float spatialBlend = 1)
        {
            ...
            controller.Play();
            if (Instance.DebugComponent) DDebug.Log("_play '" + audioClip.name + "' AudioClip", Instance);
            return controller;
        }

        /// <summary>
        /// _play the specified audio clip with the given parameters (and follow a given Transform while playing).
        /// Returns a reference to the SoundyController that is playing the sound.
        /// Returns null if the AudioClip is null.
        /// </summary>
        /// <param name="audioClip"> The AudioClip to play </param>
        ...
        /// <summary>
        /// _play a sound according to the settings in the SoundyData reference.
        ...
        public static SoundyController Play(SoundyData data)
        {
            ...
            switch (data.SoundSource)
            {
                ...
                case SoundSource.MasterAudio:
                    if (Instance.DebugComponent)
                        DDebug.Log("_play '" + data.SoundName + "' with MasterAudio", Instance);
#if dUI_MasterAudio
                    DarkTonic.MasterAudio.MasterAudio.PlaySound(data.SoundName);
                    //DDebug.Log("MasterAudio - _play Sound: " + data.SoundName);
#endif
                    break;
            }
