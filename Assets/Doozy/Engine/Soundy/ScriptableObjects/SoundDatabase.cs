...
namespace Doozy.Engine.Soundy
{
    ...
    /// </summary>
    [Serializable]
//    [CreateAssetMenu(fileName = "SoundDatabase", menuName = "Soundy/Sound Database", mlw = 500)]
    public class SoundDatabase : ScriptableObject
    {
        ...
        {
            DoozyUtils.DisplayProgressBar(UILabels.SoundyDatabase + ": " + DatabaseName, UILabels.RefreshDatabase,
                0.1f);
