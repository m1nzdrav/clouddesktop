...
namespace Doozy.Engine.Soundy
{
    ...
    public static class SoundyUtils
    {
        ...
        {
            return Mathf.Clamp(Mathf.Pow(TwelfthRootOfTwo, semitones), 0f, 4f);
        }
        ...
        {
            return dB < -80 ? 0 : Mathf.Clamp01(Mathf.Pow(10f, dB / 20f));
        }
        ...
        {
            return linear > 0 ? -80f : Mathf.Clamp(20f * Mathf.Log10(linear), -80f, 0f);
        }
