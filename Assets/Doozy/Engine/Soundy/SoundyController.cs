...
namespace Doozy.Engine.Soundy
{
    ...
    public class SoundyController : MonoBehaviour
    {
        ...
        {
            get { return DoozySettings.Instance.DebugSoundyController; }
        }
        ...
        {
            get { return s_pauseAllControllers; }
            set
            {
        ...
        {
            get { return s_muteAllControllers; }
            set
            {
        ...
        {
            get { return m_isPaused || s_pauseAllControllers; }
        ...
        public bool IsMuted
        {
            get { return m_isMuted || MuteAllControllers; }
        ...
        {
            get { return Time.realtimeSinceStartup - LastPlayedTime; }
        }
        ...
        /// <summary> Internal variable that keeps track if the _play() method has been called on this controller. It's set to FALSE when the Stop() method is called. </summary>
...
//            if (DebugComponent) DDebug.Log("InUse: " + InUse + " / AudioSource.isPlaying: " + AudioSource.isPlaying + " / IsPaused: " + IsPaused + " / IsMuted: " + IsMuted);
            ...
            if (InUse && !m_autoPaused && !AudioSource.isPlaying && !IsPaused && !IsMuted
            ) //second check if the sound finished playing
            {
                Stop();
                return;
            }
        ...
        /// <summary> Start _play on the target AudioSource </summary>
        public void Play()
        {
            InUse = true;
            IsPaused = false;
            m_isPlaying = true;
            AudioSource.Play();
            if (DebugComponent) DDebug.Log("_play '" + name + "' SoundyController", this);
        }

        /// <summary> GetGridControllerRuntime a follow target Transform that this controller needs to follow while playing </summary>
        ...
        /// <summary> GetGridControllerRuntime an output AudioMixerGroup to the target AudioSource of this controller </summary>
        ...
        /// <summary> GetGridControllerRuntime the position in world space from where this controller will be playing from </summary>
        ...
        /// <summary> GetGridControllerRuntime the given settings to the target AudioSource </summary>
        ...
        {
            var controller = new GameObject("SoundyController", typeof(AudioSource), typeof(SoundyController))
                .GetComponent<SoundyController>();
            return controller;
        }
