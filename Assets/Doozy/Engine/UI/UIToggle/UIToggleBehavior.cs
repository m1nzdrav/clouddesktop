...
namespace Doozy.Engine.UI
{
    ...
    public class UIToggleBehavior
    {
        ...
        {
            get { return Animators == null ? 0 : Animators.Count; }
        }
        ...
        {
            get { return ButtonAnimationType == ButtonAnimationType.Animator && AnimatorsCount > 0; }
        }
        ...
        {
            get { return OnToggleOn.HasAnimatorEvents || OnToggleOff.HasAnimatorEvents; }
        }
        ...
        {
            get { return OnToggleOn.HasEffect || OnToggleOff.HasEffect; }
        }
        ...
        {
            get { return OnToggleOn.HasGameEvents || OnToggleOff.HasGameEvents; }
        }
        ...
        public bool HasPunchAnimation
        {
            get
            {
                return ButtonAnimationType == ButtonAnimationType.Punch && PunchAnimation != null &&
                       (PunchAnimation.Enabled || LoadSelectedPresetAtRuntime);
            }
        }
        ...
        {
            get { return OnToggleOn.HasSound || OnToggleOff.HasSound; }
        }
        ...
        public bool HasStateAnimation
        {
            get
            {
                return ButtonAnimationType == ButtonAnimationType.State && StateAnimation != null &&
                       (StateAnimation.Enabled || LoadSelectedPresetAtRuntime);
            }
        }
        ...
        {
            get { return OnToggleOn.HasUnityEvent || OnToggleOff.HasUnityEvent; }
        }
        ...
        /// <param name="playAnimation"> _play the set animation </param>
        /// <param name="playSound"> _play the set sound </param>
        ...
        /// <param name="executeUnityEvent"> Execute the ActionEnter and the UnityEvent </param>
        public void Invoke(UIToggle toggle, bool playAnimation = true, bool playSound = true, bool executeEffect = true,
            bool executeAnimatorEvents = true, bool sendGameEvents = true, bool executeUnityEvent = true)
        {
            ...
            if (!TriggerEventsAfterAnimation)
            {
                ...
                uiAction.InvokeAction(toggle.gameObject); //ActionEnter
        ...
        public void LoadPreset(string presetCategory, string presetName)
        {
            ...
            UIAnimationData animationData =
                UIAnimations.Instance.Get(GetAnimationType(ButtonAnimationType), presetCategory, presetName);
        ...
        public void PlayAnimation(UIToggle toggle, bool withSound = true, UnityAction onStartCallback = null,
            UnityAction onCompleteCallback = null)
        {
            ...
            switch (ButtonAnimationType)
            {
                case ButtonAnimationType.Punch:
                    ...
                    UIAnimator.MovePunch(toggle.RectTransform, PunchAnimation,
                        toggle.StartPosition); //play the move punch animation
                    UIAnimator.RotatePunch(toggle.RectTransform, PunchAnimation,
                        toggle.StartRotation); //play the rotate punch animation
                    UIAnimator.ScalePunch(toggle.RectTransform, PunchAnimation,
                        toggle.StartScale); //play the scale punch animation
        ...
        private static IEnumerator InvokeCallbacks(UIAnimation animation, UnityAction onStartCallback,
            UnityAction onCompleteCallback)
        {
            if (animation == null || !animation.Enabled) yield break;
            yield return
                new WaitForSecondsRealtime(animation
                    .StartDelay); //wait for seconds realtime (ignore Unity's Time.Timescale)
            if (onStartCallback != null) onStartCallback.Invoke();
            yield return
                new WaitForSecondsRealtime(animation.TotalDuration -
                                           animation
                                               .StartDelay); //wait for seconds realtime (ignore Unity's Time.Timescale)
