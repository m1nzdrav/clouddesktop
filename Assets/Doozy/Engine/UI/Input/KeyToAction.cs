...
namespace Doozy.Engine.UI.Input
{
    ...
    public class KeyToAction : MonoBehaviour
    {
        ...
        {
            get { return DebugMode || DoozySettings.Instance.DebugKeyToAction; }
        }
        ...
        /// <summary> UIAction executed when this Key To ActionEnter is triggered </summary>
            ...
            switch (InputData.InputMode)
            {
                case InputMode.KeyCode:
                    if (UnityEngine.Input.GetKeyDown(InputData.KeyCode))
                    {
                        ...
                        {
                            if (DebugComponent)
                                DDebug.Log("Executed UIAction via KeyCode: " + InputData.KeyCode, gameObject);
                            execute = true;
                        }
                    }
                    else if (InputData.EnableAlternateInputs && UnityEngine.Input.GetKeyDown(InputData.KeyCodeAlt))
                    {
                        ...
                        {
                            if (DebugComponent)
                                DDebug.Log("Executed UIAction via KeyCode: " + InputData.KeyCodeAlt, gameObject);
                            execute = true;
                        }
                    }
                ...
                case InputMode.VirtualButton:
                    if (UnityEngine.Input.GetButtonDown(InputData.VirtualButtonName))
                    {
                        ...
                        {
                            if (DebugComponent)
                                DDebug.Log("Executed UIAction via Virtual Button: " + InputData.VirtualButtonName,
                                    gameObject);
                            execute = true;
                        }
                    }
                             ...
                             UnityEngine.Input.GetButtonDown(InputData.VirtualButtonNameAlt))
                    {
                        ...
                        {
                            if (DebugComponent)
                                DDebug.Log("Executed UIAction via Virtual Button: " + InputData.VirtualButtonNameAlt,
                                    gameObject);
                            execute = true;
                        }
                    }
        ...
        {
            return DoozyUtils.AddToScene<KeyToAction>(MenuUtils.KeyToAction_GameObject_Name, false,
