...
namespace Doozy.Engine.UI.Settings
{
    ...
    public class UIButtonSettings : ScriptableObject
    {
        ...
        {
            get { return DoozyPath.UIBUTTON_RESOURCES_PATH; }
        }
        ...
        {
            Instance.database = NamesDatabase.GetDatabase(DoozyPath.UIBUTTON_DATABASE,
                NamesDatabase.GetPath(NamesDatabaseType.UIButton));
#if UNITY_EDITOR
