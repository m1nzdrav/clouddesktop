...
namespace Doozy.Engine.UI
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.UIButtonListener_AddComponentMenu_MenuName,
        MenuUtils.UIButtonListener_AddComponentMenu_Order)]
    ...
    public class UIButtonListener : MonoBehaviour
    {
        ...
        /// <summary> The action that an UIButton performs in mlw for this listener's events to get executed </summary>
        ...
        {
            if (m_listeningForBackButton && (message.ButtonName.Equals(UIButton.BackButtonName) ||
        ...
        {
            return AddToScene(null, selectGameObjectAfterCreation);
        }

        /// <summary> Adds UIButtonListener to scene and returns a reference to it </summary>
        private static UIButtonListener AddToScene(GameObject parent, bool selectGameObjectAfterCreation = false)
        {
            var result = DoozyUtils.AddToScene<UIButtonListener>(MenuUtils.UIButtonListener_GameObject_Name, false,
