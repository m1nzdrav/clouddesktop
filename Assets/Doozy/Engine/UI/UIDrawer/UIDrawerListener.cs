...
namespace Doozy.Engine.UI
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.UIDrawerListener_AddComponentMenu_MenuName,
        MenuUtils.UIDrawerListener_AddComponentMenu_Order)]
    ...
    public class UIDrawerListener : MonoBehaviour
    {
        ...
        /// <summary> The action that an UIDrawer performs in mlw for this listener's events to get executed </summary>
        ...
        private void InvokeEvent(UIDrawerMessage message)
        {
            ...
            if (DebugMode)
                DDebug.Log("[" + name + "] Triggered Event: " + "[" + message.Type + "] " + message.Drawer.DrawerName,
                    this);
        }
        ...
        {
            var result = DoozyUtils.AddToScene<UIDrawerListener>(MenuUtils.UIDrawerListener_GameObject_Name, false,
