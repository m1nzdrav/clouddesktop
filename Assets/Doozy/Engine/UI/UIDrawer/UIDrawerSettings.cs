...
namespace Doozy.Engine.UI.Settings
{
    ...
    public class UIDrawerSettings : ScriptableObject
    {
        ...
        {
            get { return DoozyPath.UIDRAWER_RESOURCES_PATH; }
        }
        ...
        {
            Instance.database = NamesDatabase.GetDatabase(DoozyPath.UIDRAWER_DATABASE,
                NamesDatabase.GetPath(NamesDatabaseType.UIDrawer));
#if UNITY_EDITOR
