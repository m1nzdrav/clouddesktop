...
namespace Doozy.Engine.UI.Settings
{
    ...
    public class UICanvasSettings : ScriptableObject
    {
        ...
        {
            get { return DoozyPath.UICANVAS_RESOURCES_PATH; }
        }
        ...
        {
            Instance.database = NamesDatabase.GetDatabase(DoozyPath.UICANVAS_DATABASE,
                NamesDatabase.GetPath(NamesDatabaseType.UICanvas));
#if UNITY_EDITOR
