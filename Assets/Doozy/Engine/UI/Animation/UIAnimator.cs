    ...
    public static partial class UIAnimator
    {
        ...
        public static Tween FadeTween(RectTransform target, UIAnimation animation, float startValue, float endValue)
        {
            ...
            CanvasGroup canvasGroup =
                target.GetComponent<CanvasGroup>() ?? target.gameObject.AddComponent<CanvasGroup>();
        ...
        /// <summary> Fades a CanvasGroup attached to the specified target by animating an alpha value. If a CanvasGroup is not attached to the target, one will be automatically attached in mlw to perform the fade animation </summary>
        /// <param name="target"> Target RectTransform </param>
        /// <param name="animation"> Animation settings </param>
...
//            Vector3 rotationB = RotateLoopRotationB(animation, startValue);
        ...
        ///     If a CanvasGroup is not attached to the target, one will be automatically attached in mlw to perform the fade animation
        /// </summary>
        /// <param name="target"> Target RectTransform </param>
        /// <param name="animation"> Animation settings </param>
        /// <param name="onStartCallback"> Callback executed when the animation starts playing </param>
