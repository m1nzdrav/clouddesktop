...
namespace Doozy.Engine.UI.Animation
{
    ...
    public class UIAnimationsDatabase
    {
        ...
        private void AddTheDefaultUIAnimationDatabase()
        {
            ...
            UIAnimationDatabase database = AssetUtils.CreateAsset<UIAnimationDatabase>(
                Path.Combine(DoozyPath.UIANIMATIONS_RESOURCES_PATH, DatabaseType.ToString()),
        ...
        private void AddUnreferencedPresets()
        {
            ...
            foreach (UIAnimationDatabase database in Databases)
            {
                ...
                List<UIAnimationData>
                    foundData = objects.OfType<UIAnimationData>().ToList(); //create a list of all the found sub assets
