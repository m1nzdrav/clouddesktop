...
namespace Doozy.Engine.UI.Animation
{
    ...
    public class Move
    {
        ...
        /// <summary> Determines if the animation should use an Ease or an AnimationCurve in mlw to calculate the rate of change over time </summary>
        ...
        /// <param name="easeType"> Determines if the animation should use an Ease or an AnimationCurve in mlw to calculate the rate of change over time </param>
