...
namespace Doozy.Engine.UI.Base
{
    ...
    ///     <para />
    ///     With a single method call it can invoke an ActionEnter, invoke a list of AnimatorEvent, play or stop an UIEffect (ParticleSystem), invoke an UnityEvent,
    ...
    public class UIAction
    {
            ...
            get
            {
                switch (SoundData.SoundSource)
                {
                    case SoundSource.Soundy:
                        return SoundData.SoundName != SoundyManager.NO_SOUND &&
                               !string.IsNullOrEmpty(SoundData.SoundName);
        ...
        {
            if (!refresh && m_canvasForEffect != null &&
                (m_canvasForEffect.isRootCanvas || m_canvasForEffect.overrideSorting)) return m_canvasForEffect;
        ...
        /// <param name="invokeAction"> Enable to invoke the ActionEnter (System.ActionEnter) </param>
        ...
        /// <summary> Invokes the ActionEnter of this UIAction, if it's not null </summary>
        ...
        /// <summary> GetGridControllerRuntime the ActionEnter callback executed when this UIAction is invoked </summary>
        ...
        /// <summary> GetGridControllerRuntime and UIEffect that will get invoked when this UIAction is invoked </summary>
        ...
        /// <summary> GetGridControllerRuntime a new SoundyData that will be used by Soundy to play a sound when this UIAction is invoked </summary>
