...
namespace Doozy.Engine.UI.Settings
{
    ...
    public class UIPopupSettings : ScriptableObject
    {
        ...
        {
            get { return DoozyPath.UIPOPUP_RESOURCES_PATH; }
        }
        ...
        {
            Instance.database = AssetUtils.GetScriptableObject<UIPopupDatabase>("_" + DoozyPath.UIPOPUP_DATABASE,
                DoozyPath.GetDataPath(DoozyPath.ComponentName.UIPopup), false, false);
#if UNITY_EDITOR
        ...
        public const float
            DISABLE_WHEN_HIDDEN_TIME_BUFFER =
                0.05f; //after an UIPopup has been hidden, the system will wait for an additional time buffer before it sets the Source's active state to false. This is a failsafe measure and fixes a small bug on iOS
