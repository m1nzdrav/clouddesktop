...
namespace Doozy.Engine.UI
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.UIPopupManager_AddComponentMenu_MenuName,
        MenuUtils.UIPopupManager_AddComponentMenu_Order)]
    ...
    public class UIPopupManager : MonoBehaviour
    {
        ...
        {
            get { return UIPopupSettings.Database; }
        }
        ...
        {
            get { return DoozySettings.Instance.DebugUIPopupManager; }
        }
        ...
        private void Awake()
        {
            ...
            {
                DDebug.Log("There cannot be two " + typeof(UIPopupManager) +
        ...
        public static UIPopup GetPopup(string popupName)
        {
            ...
            {
                DDebug.Log(
                    "No Popups have been defined in the Popups Database. Open the Control Panel at the Popups section and add some there.");
                return null;
            }

            if (!PopupDatabase.Contains(popupName))
            {
                DDebug.Log("No Popup with the name '" + popupName +
                           "' has been defined in the Popups Database. Open the Control Panel at the Popups section and add it there.");
                return null;
            }
            ...
            if (prefab == null)
            {
                DDebug.Log("No Popup Prefab with the '" + popupName +
                           "' PopupName has been defined in the Popups Database. Open the Control Panel at the Popups section and add it there.");
                return null;
            }
        ...
        {
            return DoozyUtils.AddToScene<UIPopupManager>(MenuUtils.UIPopupManager_GameObject_Name, true,
