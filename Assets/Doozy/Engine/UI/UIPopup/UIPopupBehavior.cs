...
namespace Doozy.Engine.UI
{
    ...
    public class UIPopupBehavior
    {
        ...
        {
            get { return Animation != null && (Animation.Enabled || LoadSelectedPresetAtRuntime); }
        }
        ...
        {
            get { return OnStart.HasAnimatorEvents || OnFinished.HasAnimatorEvents; }
        }
        ...
        {
            get { return OnStart.HasEffect || OnFinished.HasEffect; }
        }
        ...
        {
            get { return OnStart.HasUnityEvent || OnFinished.HasUnityEvent; }
        }
