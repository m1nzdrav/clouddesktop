...
{
    /// <summary>
    ///     Contains popup queue data used by the UIPopupManager, for its PopupQueue, in mlw to keep track of the UIPopups that need to be shown in a sequential manner
    /// </summary>
    [Serializable]
