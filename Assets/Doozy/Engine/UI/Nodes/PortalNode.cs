...
namespace Doozy.Engine.UI.Nodes
{
    ...
    public class PortalNode : Node
    {
        ...
        {
            get { return base.HasErrors || ErrorNotListeningForAnyGameEvent && ListenFor == ListenerType.GameEvent; }
        }
        ...
        {
            get { return m_portalGraph; }
            set { m_portalGraph = value; }
        }
...
//            AddInputSocket(ConnectionMode.Multiple, typeof(PassthroughConnection), false, false);
        ...
        public override void OnEnter(Node previousActiveNode, Connection connection)
        {
            ...
            UpdateSourceNode(m_activatedByEvent
                ? previousActiveNode
                : null); //update the source to the previously active node if activated by an event
            PortalGraph.SetActiveNodeByConnection(FirstOutputSocket.FirstConnection);
        }
