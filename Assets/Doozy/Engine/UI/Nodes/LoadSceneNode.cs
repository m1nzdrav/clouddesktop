...
namespace Doozy.Engine.UI.Nodes
{
    ...
    public class LoadSceneNode : Node
    {
        ...
        {
            get { return base.HasErrors || ErrorNoSceneName || ErrorBadBuildIndex; }
        }
        ...
        public override void CheckForErrors()
        {
            ...
            ErrorBadBuildIndex = GetSceneBy == GetSceneBy.BuildIndex &&
                                 (SceneBuildIndex < 0 || SceneBuildIndex + 1 > SceneManager.sceneCountInBuildSettings);
#endif
        }
    }
}