...
namespace Doozy.Engine.Nody
{
    public class NodySettings : ScriptableObject
    {
        ...
        {
            get { return DoozyPath.ENGINE_NODY_RESOURCES_PATH; }
        }
        ...
        [Header("Node GUI")] public float FooterHeight = 10f;
        ...
        [Header("Socket GUI")] public float SocketConnectedOpacity = 1f;
        ...
        [Header("Connection GUI")] public float ConnectionPointHeight = 16f;
        ...
        [Header("Curve Settings")] public float CurvePointsMultiplier = 3f;
        ...
        [Header("Graph Tabs")] public float GraphTabDividerWidth = 1f;
        ...
        [Header("Repaint Intervals")] public double RepaintIntervalDuringPlayMode = 0.4f;
        public double RepaintIntervalWhileIdle = 0.6f;

        [Header("Editor Prefs Keys")] public string EditorPrefsKeyWindowToolbar = "Doozy.Nody.WindowToolbar";
        public string EditorPrefsKeyDotAnimationSpeed = "Doozy.Nody.DotAnimationSpeed";

        [Header("Default Node Sizes")] public float DefaultNodeHeight = 216f;
        ...
        [Header("Misc")] public HideFlags DefaultHideFlagsForNodes = HideFlags.HideInHierarchy; //HideFlags.None;
