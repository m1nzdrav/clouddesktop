...
namespace Doozy.Engine.Nody
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.GraphController_AddComponentMenu_MenuName,
        MenuUtils.GraphController_AddComponentMenu_Order)]
...
//                return m_graph;
        ...
        {
            get { return DebugMode || DoozySettings.Instance.DebugGraphController; }
        }
...
#pragma warning restore 0649
        ...
        private void Awake()
        {
            ...
            {
                DDebug.LogError(
                    "'" + Graph.name + "' " + UILabels.GraphHasNoNodes + ". " + UILabels.ComponentDisabled + ".",
                    gameObject);
                enabled = false;
                return;
            }
...
//            Initialized = true;
        ...
        {
            return DoozyUtils.AddToScene<GraphController>(MenuUtils.GraphController_GameObject_Name, false,
