...
namespace Doozy.Engine.Nody.Models
{
    ...
    public class Connection
    {
        ...
        {
            get { return m_inputSocketId; }
            set { m_inputSocketId = value; }
        }
