...
namespace Doozy.Engine.SceneManagement
{
    ...
    public class SceneLoadBehavior
    {
        ...
        {
            get { return OnLoadScene.HasAnimatorEvents || OnSceneLoaded.HasAnimatorEvents; }
        }
        ...
        {
            get { return OnLoadScene.HasEffect || OnSceneLoaded.HasEffect; }
        }
        ...
        {
            get { return OnLoadScene.HasGameEvents || OnSceneLoaded.HasGameEvents; }
        }

        /// <summary> Returns TRUE if either OnLoadScene UIAction or OnSceneLoaded UIAction have valid sound settings </summary>
        public bool HasSound
        {
            get { return OnLoadScene.HasSound || OnSceneLoaded.HasSound; }
        }
        ...
        {
            get { return OnLoadScene.HasUnityEvent || OnSceneLoaded.HasUnityEvent; }
        }
