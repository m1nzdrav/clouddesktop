...
namespace Doozy.Engine.SceneManagement
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.SceneDirector_AddComponentMenu_MenuName,
        MenuUtils.SceneDirector_AddComponentMenu_Order)]
    ...
    public class SceneDirector : MonoBehaviour
    {
        ...
        {
            get { return DebugMode || DoozySettings.Instance.DebugSceneDirector; }
        }
        ...
        private void Awake()
        {
            ...
            {
                DDebug.Log("There cannot be two " + typeof(SceneDirector) +
            ...
            Progressor progressor = null)
        {
            if (Instance.DebugComponent)
                DDebug.Log(
                    "LoadSceneAsync - sceneBuildIndex: " + sceneBuildIndex + " / loadSceneMode: " + loadSceneMode +
                    " / has Progressor: " + (progressor == null ? "No" : "Yes"), Instance);
            ...
            Progressor progressor = null)
        {
            if (Instance.DebugComponent)
                DDebug.Log(
                    "LoadSceneAsync - sceneName: " + sceneName + " / loadSceneMode: " + loadSceneMode +
                    " / has Progressor: " + (progressor == null ? "No" : "Yes"), Instance);
            SceneLoader loader = SceneLoader.GetLoader();
        ...
        {
            return DoozyUtils.AddToScene<SceneDirector>(MenuUtils.SceneDirector_GameObject_Name, true,
