...
namespace Doozy.Engine
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.GameEventListener_AddComponentMenu_MenuName,
        MenuUtils.GameEventListener_AddComponentMenu_Order)]
    ...
    public class GameEventListener : MonoBehaviour
    {
        ...
        {
            get { return DebugMode || DoozySettings.Instance.DebugGameEventListener; }
        }
        ...
        {
            var result = DoozyUtils.AddToScene<GameEventListener>(MenuUtils.GameEventListener_GameObject_Name, false,
