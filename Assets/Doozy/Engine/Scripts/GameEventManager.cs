...
namespace Doozy.Engine
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.GameEventManager_AddComponentMenu_MenuName,
        MenuUtils.GameEventManager_AddComponentMenu_Order)]
    ...
    public class GameEventManager : MonoBehaviour
    {
        ...
        {
            get { return DoozySettings.Instance.DebugGameEventManager; }
        }
        ...
        private void Awake()
        {
            ...
            {
                DDebug.Log("There cannot be two " + typeof(GameEventManager) +
        ...
        {
            return DoozyUtils.AddToScene<GameEventManager>(MenuUtils.GameEventManager_GameObject_Name, true,
