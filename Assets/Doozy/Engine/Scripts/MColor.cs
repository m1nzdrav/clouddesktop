...
namespace Doozy.Engine
{
    ...
    public class MColor
    {
        ...
        public MColor(string name,
            Color m50, Color m100, Color m200, Color m300, Color m400, Color m500, Color m600, Color m700, Color m800,
            Color m900,
        ...
        public MColor(string name,
            string m50Hex, string m100Hex, string m200Hex, string m300Hex, string m400Hex, string m500Hex,
            string m600Hex, string m700Hex, string m800Hex, string m900Hex,
