...
namespace Doozy.Engine
{
    ...
    public class GameEventMessage : Message
    {
        ...
        {
            get { return !EventName.Equals(NO_GAME_EVENT); }
        }
        ...
        {
            SendEvent(new GameEventMessage(systemGameEvent));
        }
        ...
        {
            SendEvent(new GameEventMessage(gameEvent));
        }
        ...
        {
            SendEvent(new GameEventMessage(source));
        }
        ...
        {
            SendEvent(new GameEventMessage(systemGameEvent, source));
        }
        ...
        {
            SendEvent(new GameEventMessage(gameEvent, source));
        }
        ...
        {
            SendEvent(new GameEventMessage(gameEvent, customObject));
        }
        ...
        {
            SendEvent(new GameEventMessage(source, customObject));
        }
        ...
        {
            SendEvent(new GameEventMessage(gameEvent, source, customObject));
        }
