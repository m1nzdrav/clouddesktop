...
namespace Doozy.Engine.Orientation
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.OrientationDetector_AddComponentMenu_MenuName,
        MenuUtils.OrientationDetector_AddComponentMenu_Order)]
    ...
    public class OrientationDetector : MonoBehaviour
    {
...
#if UNITY_EDITOR
        [UnityEditor.MenuItem(MenuUtils.OrientationDetector_MenuItem_ItemName, false,
            MenuUtils.OrientationDetector_MenuItem_Priority)]
        ...
        {
            get { return DebugMode || DoozySettings.Instance.DebugOrientationDetector; }
        }
        ...
        private void Awake()
        {
            ...
            {
                DDebug.Log("There cannot be two " + typeof(OrientationDetector) +
...
//#endif
        ...
        public void CheckDeviceOrientation(bool forceUpdate = false)
        {
            ...
            {
                if (m_currentOrientation != DetectedOrientation.Portrait || forceUpdate
            ...
            {
                if (m_currentOrientation != DetectedOrientation.Landscape || forceUpdate
        ...
        {
            return DoozyUtils.AddToScene<OrientationDetector>(MenuUtils.OrientationDetector_GameObject_Name, true,
