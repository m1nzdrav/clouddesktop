...
namespace Doozy.Engine.Progress
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.ProgressTargetText_AddComponentMenu_MenuName,
        MenuUtils.ProgressTargetText_AddComponentMenu_Order)]
...
#if UNITY_EDITOR
        [MenuItem(MenuUtils.ProgressTargetText_MenuItem_ItemName, false,
            MenuUtils.ProgressTargetText_MenuItem_Priority)]
        private static void CreateComponent(MenuCommand menuCommand)
        {
            DoozyUtils.AddToScene<ProgressTargetText>(MenuUtils.ProgressTargetText_GameObject_Name, false, true);
        }
#endif
