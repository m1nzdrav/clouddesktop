...
namespace Doozy.Engine.Progress
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.ProgressTargetAudioMixer_AddComponentMenu_MenuName,
        MenuUtils.ProgressTargetAudioMixer_AddComponentMenu_Order)]
    ...
    public class ProgressTargetAudioMixer : ProgressTarget
    {
...
#if UNITY_EDITOR
        [MenuItem(MenuUtils.ProgressTargetAudioMixer_MenuItem_ItemName, false,
            MenuUtils.ProgressTargetAudioMixer_MenuItem_Priority)]
        private static void CreateComponent(MenuCommand menuCommand)
        {
            DoozyUtils.AddToScene<ProgressTargetAudioMixer>(MenuUtils.ProgressTargetAudioMixer_GameObject_Name, false,
                true);
        }
#endif
        ...
        public override void UpdateTarget(Progressor progressor)
        {
            ...
            TargetMixer.SetFloat(ExposedParameterName,
                UseLogarithmicConversion ? GetLogarithmicValue(progressor.Progress) : progressor.Value);
        }
        ...
        {
            return Mathf.Log10(Mathf.Clamp(value, MIN_VALUE, MAX_VALUE)) * 20;
        }
