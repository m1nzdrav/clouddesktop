...
namespace Doozy.Engine.Progress
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.ProgressTargetAnimator_AddComponentMenu_MenuName,
        MenuUtils.ProgressTargetAnimator_AddComponentMenu_Order)]
    ...
    public class ProgressTargetAnimator : ProgressTarget
    {
...
#if UNITY_EDITOR
        [MenuItem(MenuUtils.ProgressTargetAnimator_MenuItem_ItemName, false,
            MenuUtils.ProgressTargetAnimator_MenuItem_Priority)]
        private static void CreateComponent(MenuCommand menuCommand)
        {
            DoozyUtils.AddToScene<ProgressTargetAnimator>(MenuUtils.ProgressTargetAnimator_GameObject_Name, false,
                true);
        }
#endif
        ...
        public override void UpdateTarget(Progressor progressor)
        {
            ...
            Animator.SetFloat(ParameterName,
                TargetProgress == TargetProgress.Progress ? progressor.Progress : progressor.InverseProgress);
        }
