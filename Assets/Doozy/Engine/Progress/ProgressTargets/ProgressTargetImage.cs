...
namespace Doozy.Engine.Progress
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.ProgressTargetImage_AddComponentMenu_MenuName,
        MenuUtils.ProgressTargetImage_AddComponentMenu_Order)]
    ...
    public class ProgressTargetImage : ProgressTarget
    {
...
#if UNITY_EDITOR
        [MenuItem(MenuUtils.ProgressTargetImage_MenuItem_ItemName, false,
            MenuUtils.ProgressTargetImage_MenuItem_Priority)]
        private static void CreateComponent(MenuCommand menuCommand)
        {
            DoozyUtils.AddToScene<ProgressTargetImage>(MenuUtils.ProgressTargetImage_GameObject_Name, false, true);
        }
#endif
        ...
        public override void UpdateTarget(Progressor progressor)
        {
            ...
            Image.fillAmount = TargetProgress == TargetProgress.Progress
                ? progressor.Progress
                : progressor.InverseProgress;
        }
