...
namespace Doozy.Engine.Progress
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.ProgressTargetAction_AddComponentMenu_MenuName,
        MenuUtils.ProgressTargetAction_AddComponentMenu_Order)]
...
#if UNITY_EDITOR
        [MenuItem(MenuUtils.ProgressTargetAction_MenuItem_ItemName, false,
            MenuUtils.ProgressTargetAction_MenuItem_Priority)]
        private static void CreateComponent(MenuCommand menuCommand)
        {
            DoozyUtils.AddToScene<ProgressTargetAction>(MenuUtils.ProgressTargetAction_GameObject_Name, false, true);
        }
#endif
