...
namespace Doozy.Engine.Progress
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.ProgressorGroup_AddComponentMenu_MenuName,
        MenuUtils.ProgressorGroup_AddComponentMenu_Order)]
    ...
    public class ProgressorGroup : MonoBehaviour
    {
        ...
        {
            get { return DebugMode || DoozySettings.Instance.DebugProgressorGroup; }
        }
        ...
        /// <summary> GetParent either the Progress or the InverseProgress value, depending on the requested direction </summary>
        ...
        {
            if (DebugComponent)
                DDebug.Log("[" + name + "] Progress: " + Progress + " / Inverse Progress: " + InverseProgress, this);
        ...
        {
            return DoozyUtils.AddToScene<ProgressorGroup>(MenuUtils.ProgressorGroup_GameObject_Name, false,
