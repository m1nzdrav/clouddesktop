...
namespace Doozy.Engine.Progress
{
    ...
    public class Progressor : MonoBehaviour
    {
        ...
        public float Value
        {
            ...
            private set { m_currentValue = value; }
        }
        ...
        {
            get { return DebugMode || DoozySettings.Instance.DebugProgressor; }
        }

        private string GetAnimationId
        {
            get { return GetInstanceID() + " - Progressor Animation"; }
        }
...
//            m_previousValue = Value;
        ...
        {
            SetValue(m_minValue + Mathf.Clamp01(progressValue) * (m_maxValue - m_minValue), instantUpdate);
        }
        ...
        public void UpdateProgress()
        {
            if (DebugComponent)
                DDebug.Log(
                    "[" + name + "] Value: " + Value + " / Progress: " + Progress + " / Inverse Progress: " +
                    InverseProgress, this);
...
//                          .SetSpeedBased(true)
        ...
        {
            return DoozyUtils.AddToScene<Progressor>(MenuUtils.Progressor_GameObject_Name, false,
