...
namespace Doozy.Engine.Themes
{
    ...
    public class ThemeVariantData : ISerializationCallbackReceiver
    {
        ...
        [SerializeField] private string m_variantName = DEFAULT_THEME_VARIANT_NAME;
        ...
        {
            Colors.Add(new ColorId(guid, Color.white));
        }
        ...
        {
            Colors.Add(new ColorId(guid, color));
        }
        ...
        {
            return Colors.Any(p => p.Id.Equals(propertyId));
        }

        /// <summary> GetParent the Color with the given property Id </summary>
        /// <param name="propertyId"> Property Id </param>
        ...
        {
            Sprites.Add(new SpriteId(guid, null));
        }
        ...
        {
            Sprites.Add(new SpriteId(guid, sprite));
        }
        ...
        {
            return Sprites.Any(p => p.Id.Equals(propertyId));
        }

        /// <summary> GetParent the Sprite reference with the given property Id </summary>
        /// <param name="propertyId"> Property Id </param>
        ...
        {
            Textures.Add(new TextureId(guid, null));
        }
        ...
        {
            Textures.Add(new TextureId(guid, texture));
        }
        ...
        {
            return Textures.Any(p => p.Id.Equals(propertyId));
        }

        /// <summary> GetParent the Texture reference with the given property Id </summary>
        /// <param name="propertyId"> Property Id </param>
        ...
        {
            Fonts.Add(new FontId(guid, DefaultFont));
        }
        ...
        {
            Fonts.Add(new FontId(guid, font));
        }
        ...
        {
            return Fonts.Any(p => p.Id.Equals(propertyId));
        }

        /// <summary> GetParent the Font reference with the given property Id </summary>
        /// <param name="propertyId"> Property Id </param>
        ...
        /// <summary> GetParent the FontAsset reference with the given property Id </summary>
        /// <param name="propertyId"> Property Id </param>
