...
namespace Doozy.Engine.Themes
{
    ...
    public class ThemeData : ScriptableObject, ISerializationCallbackReceiver
    {
        ...
        [SerializeField] private string m_themeName = UNNAMED_THEME_NAME;
        ...
        [SerializeField] private ThemeVariantData m_activeVariant;
        ...
        /// <summary> GetParent the currently active theme variant. If the active variant has not been set, the first variant from the Variants list will get automatically selected </summary>
        ...
        {
            get { return ThemeName.Equals(ThemesDatabase.GENERAL_THEME_NAME); }
        }
        ...
        {
            return ColorLabels != null && ColorLabels.Any(colorLabel => colorLabel.Id.Equals(propertyId));
        }
        ...
        {
            return SpriteLabels != null && SpriteLabels.Any(spriteLabel => spriteLabel.Id.Equals(propertyId));
        }
        ...
        {
            return TextureLabels != null && TextureLabels.Any(textureLabel => textureLabel.Id.Equals(propertyId));
        }
        ...
        {
            return FontLabels != null && FontLabels.Any(fontLabel => fontLabel.Id.Equals(propertyId));
        }
        ...
        {
            return FontAssetLabels != null &&
                   FontAssetLabels.Any(fontAssetLabel => fontAssetLabel.Id.Equals(propertyId));
        }
        ...
        {
            return Variants != null && Variants.Any(variant => variant.Id.Equals(variantGuid));
        }
        ...
        {
            return Variants != null && Variants.Any(variant => variant.VariantName.Equals(variantName));
        }

        /// <summary> GetParent the variant with the given Guid </summary>
        /// <param name="variantId"> Variant Id </param>
        public ThemeVariantData GetVariant(Guid variantId)
        {
            return Variants.FirstOrDefault(variant => variant.Id.Equals(variantId));
        }

        /// <summary> GetParent the variant with the given name </summary>
        /// <param name="variantName"> Variant name </param>
        public ThemeVariantData GetVariant(string variantName)
        {
            return Variants.FirstOrDefault(variant => variant.VariantName.Equals(variantName));
        }

        /// <summary> GetParent the color property index by searching for the given Guid </summary>
        /// <param name="id"> Guid value to search for </param>
        public int GetColorPropertyIndex(Guid id)
        {
            return GetPropertyIndex(id, ColorLabels);
        }

        /// <summary> GetParent the sprite property index by searching for the given Guid </summary>
        /// <param name="id"> Guid value to search for </param>
        public int GetSpritePropertyIndex(Guid id)
        {
            return GetPropertyIndex(id, SpriteLabels);
        }

        /// <summary> GetParent the texture property index by searching for the given Guid </summary>
        /// <param name="id"> Guid value to search for </param>
        public int GetTexturePropertyIndex(Guid id)
        {
            return GetPropertyIndex(id, TextureLabels);
        }

        /// <summary> GetParent the font property index by searching for the given Guid </summary>
        /// <param name="id"> Guid value to search for </param>
        public int GetFontPropertyIndex(Guid id)
        {
            return GetPropertyIndex(id, FontLabels);
        }

        /// <summary> GetParent the font asset property index by searching for the given Guid </summary>
        /// <param name="id"> Guid value to search for </param>
        public int GetFontAssetPropertyIndex(Guid id)
        {
            return GetPropertyIndex(id, FontAssetLabels);
        }

        /// <summary> GetParent the variant index by searching for the given Guid </summary>
        /// <param name="id"> Guid value to search for </param>
        ...
        public void RefreshThemeVariants(bool showProgress, bool performUndo, bool saveAssets)
        {
            ...
            bool addedDefaultColorLabels =
                ColorLabels.Count == 0; //if the color properties list is empty -> add the default color labels
        ...
        /// <param name="saveAssets"> Write all unsaved asset changes to disk? </param>
        public bool RemoveVariant(ThemeVariantData data, bool performUndo = false, bool showDialog = false,
        ...
        /// <summary> GetParent the index of the property with the given id from the given property list </summary>
