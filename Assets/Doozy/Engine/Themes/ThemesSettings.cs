...
namespace Doozy.Engine.Themes
{
    ...
    public class ThemesSettings : ScriptableObject
    {
        ...
        {
            get { return DoozyPath.ENGINE_THEMES_RESOURCES_PATH; }
        }
        ...
        {
            Instance.database = AssetUtils.GetScriptableObject<ThemesDatabase>("_" + DoozyPath.THEMES_DATABASE,
                DoozyPath.GetDataPath(DoozyPath.ComponentName.Themes), false, false);
