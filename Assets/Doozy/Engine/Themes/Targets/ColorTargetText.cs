...
namespace Doozy.Engine.Themes
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.ColorTargetText_AddComponentMenu_MenuName,
        MenuUtils.ColorTargetText_AddComponentMenu_Order)]
    ...
    public class ColorTargetText : ThemeTarget
    {
        ...
        {
            DoozyUtils.AddToScene<ColorTargetText>(MenuUtils.ColorTargetText_GameObject_Name, false, true);
        }
#endif
