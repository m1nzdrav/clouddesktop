...
namespace Doozy.Engine.Themes
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.TextureTargetUnityEvent_AddComponentMenu_MenuName,
        MenuUtils.TextureTargetUnityEvent_AddComponentMenu_Order)]
...
#if UNITY_EDITOR
        [MenuItem(MenuUtils.TextureTargetUnityEvent_MenuItem_ItemName, false,
            MenuUtils.TextureTargetUnityEvent_MenuItem_Priority)]
        private static void CreateComponent(MenuCommand menuCommand)
        {
            DoozyUtils.AddToScene<TextureTargetUnityEvent>(MenuUtils.TextureTargetUnityEvent_GameObject_Name, false,
                true);
        }
#endif
