...
namespace Doozy.Engine.Themes
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.SpriteTargetSpriteRenderer_AddComponentMenu_MenuName,
        MenuUtils.SpriteTargetSpriteRenderer_AddComponentMenu_Order)]
...
#if UNITY_EDITOR
        [MenuItem(MenuUtils.SpriteTargetSpriteRenderer_MenuItem_ItemName, false,
            MenuUtils.SpriteTargetSpriteRenderer_MenuItem_Priority)]
        private static void CreateComponent(MenuCommand menuCommand)
        {
            DoozyUtils.AddToScene<SpriteTargetSpriteRenderer>(MenuUtils.SpriteTargetSpriteRenderer_GameObject_Name,
                false, true);
        }
#endif
