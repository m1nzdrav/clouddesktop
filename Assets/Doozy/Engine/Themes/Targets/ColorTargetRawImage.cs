...
namespace Doozy.Engine.Themes
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.ColorTargetRawImage_AddComponentMenu_MenuName,
        MenuUtils.ColorTargetRawImage_AddComponentMenu_Order)]
...
#if UNITY_EDITOR
        [MenuItem(MenuUtils.ColorTargetRawImage_MenuItem_ItemName, false,
            MenuUtils.ColorTargetRawImage_MenuItem_Priority)]
        private static void CreateComponent(MenuCommand menuCommand)
        {
            DoozyUtils.AddToScene<ColorTargetRawImage>(MenuUtils.ColorTargetRawImage_GameObject_Name, false, true);
        }
#endif
