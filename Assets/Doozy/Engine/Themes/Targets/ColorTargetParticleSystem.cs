...
namespace Doozy.Engine.Themes
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.ColorTargetParticleSystem_AddComponentMenu_MenuName,
        MenuUtils.ColorTargetParticleSystem_AddComponentMenu_Order)]
...
#if UNITY_EDITOR
        [MenuItem(MenuUtils.ColorTargetParticleSystem_MenuItem_ItemName, false,
            MenuUtils.ColorTargetParticleSystem_MenuItem_Priority)]
        private static void CreateComponent(MenuCommand menuCommand)
        {
            DoozyUtils.AddToScene<ColorTargetParticleSystem>(MenuUtils.ColorTargetParticleSystem_GameObject_Name, false,
                true);
        }
#endif
