...
namespace Doozy.Engine.Themes
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.SpriteTargetUnityEvent_AddComponentMenu_MenuName,
        MenuUtils.SpriteTargetUnityEvent_AddComponentMenu_Order)]
...
#if UNITY_EDITOR
        [MenuItem(MenuUtils.SpriteTargetUnityEvent_MenuItem_ItemName, false,
            MenuUtils.SpriteTargetUnityEvent_MenuItem_Priority)]
        private static void CreateComponent(MenuCommand menuCommand)
        {
            DoozyUtils.AddToScene<SpriteTargetUnityEvent>(MenuUtils.SpriteTargetUnityEvent_GameObject_Name, false,
                true);
        }
#endif
