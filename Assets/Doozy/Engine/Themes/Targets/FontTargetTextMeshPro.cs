...
namespace Doozy.Engine.Themes
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.FontTargetTextMeshPro_AddComponentMenu_MenuName,
        MenuUtils.FontTargetTextMeshPro_AddComponentMenu_Order)]
...
#if UNITY_EDITOR
        [MenuItem(MenuUtils.FontTargetTextMeshPro_MenuItem_ItemName, false,
            MenuUtils.FontTargetTextMeshPro_MenuItem_Priority)]
        private static void CreateComponent(MenuCommand menuCommand)
        {
            DoozyUtils.AddToScene<FontTargetTextMeshPro>(MenuUtils.FontTargetTextMeshPro_GameObject_Name, false, true);
        }
#endif
