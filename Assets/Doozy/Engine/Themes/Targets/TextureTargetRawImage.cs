...
namespace Doozy.Engine.Themes
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.TextureTargetRawImage_AddComponentMenu_MenuName,
        MenuUtils.TextureTargetRawImage_AddComponentMenu_Order)]
...
#if UNITY_EDITOR
        [MenuItem(MenuUtils.TextureTargetRawImage_MenuItem_ItemName, false,
            MenuUtils.TextureTargetRawImage_MenuItem_Priority)]
        private static void CreateComponent(MenuCommand menuCommand)
        {
            DoozyUtils.AddToScene<TextureTargetRawImage>(MenuUtils.TextureTargetRawImage_GameObject_Name, false, true);
        }
#endif
