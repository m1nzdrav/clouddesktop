...
namespace Doozy.Engine.Themes
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.SpriteTargetSelectable_AddComponentMenu_MenuName,
        MenuUtils.SpriteTargetSelectable_AddComponentMenu_Order)]
...
#if UNITY_EDITOR
        [MenuItem(MenuUtils.SpriteTargetSelectable_MenuItem_ItemName, false,
            MenuUtils.SpriteTargetSelectable_MenuItem_Priority)]
        private static void CreateComponent(MenuCommand menuCommand)
        {
            DoozyUtils.AddToScene<SpriteTargetSelectable>(MenuUtils.SpriteTargetSelectable_GameObject_Name, false,
                true);
        }
#endif
