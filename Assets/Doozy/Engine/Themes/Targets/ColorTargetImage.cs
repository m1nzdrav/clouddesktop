...
namespace Doozy.Engine.Themes
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.ColorTargetImage_AddComponentMenu_MenuName,
        MenuUtils.ColorTargetImage_AddComponentMenu_Order)]
    ...
    public class ColorTargetImage : ThemeTarget
    {
        ...
        {
            DoozyUtils.AddToScene<ColorTargetImage>(MenuUtils.ColorTargetImage_GameObject_Name, false, true);
        }
#endif
