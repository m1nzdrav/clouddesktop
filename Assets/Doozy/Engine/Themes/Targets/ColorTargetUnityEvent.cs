...
namespace Doozy.Engine.Themes
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.ColorTargetUnityEvent_AddComponentMenu_MenuName,
        MenuUtils.ColorTargetUnityEvent_AddComponentMenu_Order)]
...
#if UNITY_EDITOR
        [MenuItem(MenuUtils.ColorTargetUnityEvent_MenuItem_ItemName, false,
            MenuUtils.ColorTargetUnityEvent_MenuItem_Priority)]
        private static void CreateComponent(MenuCommand menuCommand)
        {
            DoozyUtils.AddToScene<ColorTargetUnityEvent>(MenuUtils.ColorTargetUnityEvent_GameObject_Name, false, true);
        }
#endif
