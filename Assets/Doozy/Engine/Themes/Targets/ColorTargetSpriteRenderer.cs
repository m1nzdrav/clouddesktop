...
namespace Doozy.Engine.Themes
{
    ...
    /// </summary>
    [AddComponentMenu(MenuUtils.ColorTargetSpriteRenderer_AddComponentMenu_MenuName,
        MenuUtils.ColorTargetSpriteRenderer_AddComponentMenu_Order)]
...
#if UNITY_EDITOR
        [MenuItem(MenuUtils.ColorTargetSpriteRenderer_MenuItem_ItemName, false,
            MenuUtils.ColorTargetSpriteRenderer_MenuItem_Priority)]
        private static void CreateComponent(MenuCommand menuCommand)
        {
            DoozyUtils.AddToScene<ColorTargetSpriteRenderer>(MenuUtils.ColorTargetSpriteRenderer_GameObject_Name, false,
                true);
        }
#endif
