...
namespace Doozy.Engine.Themes
{
    ...
    public class ThemesDatabase : ScriptableObject
    {
        ...
        {
            return CreateTheme(DoozyPath.GetDataPath(DoozyPath.ComponentName.Themes), themeName, showDialog,
                saveAssets);
        }
...
#if UNITY_EDITOR
            ThemeData themeData = AssetUtils.CreateAsset<ThemeData>(relativePath,
                GetThemeDataFilename(themeName.Replace(" ", string.Empty)));
        ...
        /// <summary> GetParent the ThemeData reference by searching through the database to look for the theme with the given id. If a theme with the given id is not found, it will return null </summary>
        ...
        /// <summary> GetParent the ThemeData reference by searching through the database to look for the first theme with the given theme name. If a theme with the given name is not found, it will return null </summary>
        ...
        /// <summary> GetParent the theme index by Guid </summary>
        ...
        /// <summary> GetParent the ThemeVariantData by Guid </summary>
        ...
        {
            return Themes.Any(theme => theme.ThemeName.Equals(themeName));
        }
        ...
        public bool RenameThemeData(ThemeData themeData, string newThemeName)
        {
            ...
            AssetDatabase.RenameAsset(AssetDatabase.GetAssetPath(themeData),
                GetThemeDataFilename(newThemeName.Replace(" ", string.Empty)));
            UpdateThemesNames(true);
#endif
            return true;
        }
        ...
        public void SearchForUnregisteredThemes(bool saveAssets)
        {
            ...
            for (int i = 0; i < array.Length; i++)
            {
                ...
                DoozyUtils.DisplayProgressBar(UILabels.SearchForThemes, UILabels.Search,
                    0.1f + 0.1f + 0.7f * (i + 1) / array.Length);
        ...
        /// <summary> GetParent a string array of all the theme names found in the database </summary>
        ...
        /// <summary> GetParent a string array of all the variant names found in a theme </summary>
        ...
        {
            return THEME_ASSET_PREFIX + themeName.Trim();
        }
