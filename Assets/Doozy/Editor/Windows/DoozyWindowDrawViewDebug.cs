            ...
            GUILayout.BeginHorizontal();
            {
                ...
                GUILayout.BeginVertical();
                {
                    ...
                    GUILayout.BeginHorizontal();
                    {
                        ...
                        EditorGUI.BeginChangeCheck();
                        debugKeyToAction = DrawDebugButton(debugKeyToAction, "Key To ActionEnter", Styles.GetStyle(Styles.StyleName.IconKeyToAction), DGUI.Colors.KeyToActionColorName);
                        if (EditorGUI.EndChangeCheck())
                        {
                            DoozySettings.Instance.UndoRecord("DDebug");
