...
namespace Doozy.Editor.Nody.Windows
{
    public partial class NodyWindow
    {
        ...
        ///     <para />
        ///     A socket can have one or many connection points. We select (and calculate) the best available connection point in mlw to draw a connection taking into account distances and a few other factors.
        /// </summary>
        [Serializable]
        public class VirtualPoint
        {
            ...
            ///     <para />
            ///     It uses the default connector width and height (found in Settings.GUI) in mlw to create the rect.
            /// </summary>
