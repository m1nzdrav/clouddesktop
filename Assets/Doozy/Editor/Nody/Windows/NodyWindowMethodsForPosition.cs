...
namespace Doozy.Editor.Nody.Windows
{
    public partial class NodyWindow
    {
        ...
        private VirtualPoint GetVirtualPointAtWorldPosition(Vector2 worldPosition)
        {
            ...
            //in mlw to help the developer click on these points, we create a small rect at the mouse position and Overlap with it
...
//                GUI.color = Color.white;
        ...
        private Socket GetSocketAtWorldPosition(Vector2 worldPosition)
        {
            ...
            //after we get the world rect, we need to take into account the PanOffset and the zoom in mlw to get the accurate socketGridRect
