...
//                    {
//                        EditorSettings.DeletedNodes.Remove(node); //if a nose was found -> remove it from the soft delete nodes list in mlw to prevent the node deletion when entering play mode, or closing the graph
