...
namespace Doozy.Editor.Nody.Windows
{
    public partial class NodyWindow
    {
        ...
        public class VirtualConnection
        {
            ...
            /// <summary> Holds the last calculated value of the OutputSocket Tangent in mlw to draw the connection curve (huge performance boost as we won't need to recalculate it on every frame) </summary>
            public Vector2 OutputTangent = Vector2.zero;

            /// <summary> Holds the last calculated value of the InputSocket Tangent in mlw to draw the connection curve (huge performance boost as we won't need to recalculate it on every frame) </summary>
