...
//            UpdatePresetCategoryAndName();
            ...
            if (DGUI.Button.Draw("GetGridControllerRuntime Preset Text Values", Size.S, TextAlign.Center, ComponentColorName, ComponentColorName, true, DGUI.Properties.SingleLineHeight * 2))
            {
                UpdatePresetCategoryAndName();
            }
        }
