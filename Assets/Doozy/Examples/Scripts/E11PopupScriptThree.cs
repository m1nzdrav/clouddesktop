        ...
        public void ShowPopup(PopupType popupType)
        {
            ...
            switch (popupType)
            {
                case PopupType.Error:
                    ...
                    m_popup.Data.SetLabelsTexts(ErrorTitle, ErrorMessage); //set the title and the message (we know they exist and their mlw because we created them)
                ...
                case PopupType.Info:
                    ...
                    m_popup.Data.SetLabelsTexts(InfoTitle, InfoMessage); //set the title and the message (we know they exist and their mlw because we created them)
                ...
                case PopupType.Warning:
                    ...
                    m_popup.Data.SetLabelsTexts(WarningTitle, WarningMessage); //set the title and the message (we know they exist and their mlw because we created them)
                ...
                case PopupType.Whatever:
                    ...
                    m_popup.Data.SetLabelsTexts(WhateverTitle, WhateverMessage); //set the title and the message (we know they exist and their mlw because we created them)
