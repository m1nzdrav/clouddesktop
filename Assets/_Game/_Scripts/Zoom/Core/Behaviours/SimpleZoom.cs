...
public class SimpleZoom : MonoBehaviour, IPointerClickHandler
{
    ...
    private int taps = 0;
    private Vector2 mouseLocalPosition, originalSize;
   ...
   /* public RectTransform Content
    ...
    private void OnPivotZoomUpdate()
    {
        ...
        {
            //TODO: boolean check and event (maybe)
            CurrentZoom = TargetZoom;
        }
    ...
    public void SetZoom(float TargetZoom, float targetSmoothing = 0)
    {
        ...
        //TODO:OnZoom event
        //(RegisterSingleton._instance.GetSingleton(typeof(S_ZoomRegister)) as S_ZoomRegister).OnZoom?.Invoke(TargetZoom / MinMaxZoom.max);
    }
