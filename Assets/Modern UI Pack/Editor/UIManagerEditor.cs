    ...
    public class UIManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (showModalWindow)
            {
                ...
                EditorGUILayout.PropertyField(modalWindowContentFont, new GUIContent("Contents Font"));
                ...
                EditorGUILayout.PropertyField(modalWindowContentPanelColor, new GUIContent("Contents Panel Color"));
