        ...
        void Start()
        {
            try
            {
                ...
                if (useCustomContent == false)
                {
                    ...
                    {
                        iconObj = gameObject.transform.Find("Contents/Icon").GetComponent<Image>();
                        titleObj = gameObject.transform.Find("Contents/Title").GetComponent<TextMeshProUGUI>();
                        descriptionObj = gameObject.transform.Find("Contents/Description").GetComponent<TextMeshProUGUI>();
                    }
