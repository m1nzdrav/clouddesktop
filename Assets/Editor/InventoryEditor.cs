...
{
    Inventory inv;
    private SerializedProperty SlotContainer;
    SerializedProperty PanelRectTransform;
     SerializedProperty prefabSlot;
...
//    SerializedProperty mainInventory;
    ...
    void OnEnable()
    {
        ...
        SlotContainer=serializedObject.FindProperty("SlotContainer");
        PanelRectTransform=serializedObject.FindProperty("PanelRectTransform");
        prefabSlot=serializedObject.FindProperty("prefabSlot");
...
//        EditorGUILayout.PropertyField(mainInventory, new GUIContent("Player Inventory"));
        ...
        EditorGUILayout.PropertyField(prefabSlot, new GUIContent("prefabSlot"));
        EditorGUILayout.PropertyField(PanelRectTransform, new GUIContent("PanelRectTransform"));
        EditorGUILayout.PropertyField(SlotContainer, new GUIContent("SlotContainer"));
...
//        }
    ...
    void sizeOfInventoryGUI()
    {
        ...
        EditorGUI.indentLevel++;
        EditorGUI.BeginChangeCheck();
        EditorGUILayout.IntSlider(inventoryHeight, 1, 20, new GUIContent("Height"));
        EditorGUILayout.IntSlider(inventoryWidth, 1, 20, new GUIContent("Width"));
        if (EditorGUI.EndChangeCheck())
        {
